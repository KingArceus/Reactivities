...
import { Box, Chip, Button, CardContent, Card, Avatar, CardHeader, Divider, Typography } from "@mui/material";
        ...
        <Card elevation={3} sx={{ borderRadius: 3 }}>
            <Box display={'flex'} justifyContent={'space-between'} alignItems={'center'} p={2}>
                <CardHeader avatar={<Avatar sx={{ height: 80, width: 80 }} />}
                    ...
                    slotProps={{ fontWeigth: 'bold', fontSize: 20 }}
                    subheader={
                        <>
            ...
            <CardContent sx={{ pb: 2 }}>
                ...
                <Button component={Link} to={`/activities/${activity.id}`} size="medium" variant="contained" sx={{ display: 'flex', justifySelf: 'self-end', borderRadius: 3 }}>
                    View
                </Button>
            </CardContent>
        </Card>
